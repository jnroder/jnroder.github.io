        ...
        <>
            ...
            <div className="page-content max-w-screen-xl">
                <div className="px-4 sm:px-0">
                    <h1 className="text-2xl font-semibold leading-7 text-gray-900">Jared Roder</h1>
                    <p className="flex flex-col sm:flex-row justify-center mt-1 text-base leading-6 text-gray-500 text-center">
                ...
                <div className="mt-6 border-t border-gray-100 text-left">
                    <dl className="divide-y divide-gray-100">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold leading-6 text-gray-900">Technical Skills</dt>
                            <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-span-3 sm:mt-0">
                                <ul className="list-disc list-inside mt-3 sm:mt-0">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold leading-6 text-gray-900">Professional Experience</dt>
                            <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-span-3 sm:mt-0">
                                <p className="text-lg font-bold text-gray-700 mt-5 sm:mt-0">Senior Front End Web Developer, Merkle, Inc.</p>
                                <p><em>August 2021 - September 2024</em></p>
                                <div className="sm:pl-4">
                                    <p className="text-medium font-semibold text-gray-900 underline mt-4">Under Armour (<a href="http://underarmour.com/">underarmour.com</a>)</p>
                                    ...
                                    <p className="text-medium font-semibold text-gray-900 underline mt-4">Johnson &amp; Johnson (Neostrata, Neutrogena, Exuviance, Rogaine/Regaine)</p>
                                ...
                                <p className="text-lg font-bold text-gray-700 mt-7 sm:mt-5">Front End Web Developer, PFSweb, LiveArea</p>
                                <p><em>August 2014 - August 2021</em></p>
                                <div className="sm:pl-4">
                                    <p className="text-medium font-semibold text-gray-900 underline mt-4">Peter Millar (<a href="http://petermillar.com/">petermillar.com</a>)</p>
                                    ...
                                    <p className="text-medium font-semibold text-gray-900 underline mt-4">method (<a href="https://methodproducts.com">methodproducts.com</a>)</p>
                                    ...
                                    <p className="text-medium font-semibold text-gray-900 underline mt-4">Lancôme (<a href="http://lancome.com/">lancome.com</a>)</p>
                                    ...
                                    <p className="text-medium font-semibold text-gray-900 underline mt-4">Fullbeauty Brands (<a href="https://www.fbbrands.com/">fbbrands.com</a> &amp; affiliate sites)</p>
                                    ...
                                    <p className="text-medium font-semibold text-gray-700 mt-4">Additional Projects</p>
                                    <ul className="list-disc list-inside mt-3 sm:mt-0">
                                ...
                                <p className="text-lg font-bold text-gray-700 mt-7 sm:mt-5">Front End Web Developer, Impremis Technology</p>
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold leading-6 text-gray-900">Education</dt>
                            <dd className="mt-1 text-base leading-6 text-gray-700 sm:col-span-3 sm:mt-0">
                                <p className="text-lg font-bold text-gray-700 mt-5 sm:mt-0">Bachelor of Science, Computer Science</p>
                                <p>Abilene Christian University</p>
                            </dd>
                        </div>
                        
                        <div className="px-4 py-6 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
                            <dt className="text-lg font-bold leading-6 text-gray-900">PDF Download</dt>
                            <dd className="mt-2 text-base text-gray-900 sm:col-span-3 sm:mt-0">
                                    ...
                                    <li className="flex items-center justify-between py-4 sm:pl-4 pr-5 text-base leading-6">
                                        <div className="flex w-0 flex-1 items-center">
                                            ...
                                            <div className="ml-4 flex min-w-0 flex-1 gap-2">
                                                ...
                                                <span className="flex-shrink-0 text-gray-400">66kb</span>
                                            </div>
                                        </div>
